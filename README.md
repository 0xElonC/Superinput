...
- New browser input replaces the previous captured text and previous translation.
...
5. If you type new text, the new input replaces the previous captured text and translation.
6. Press `Enter` to clear the current state when `Enter 后清空` is enabled.
